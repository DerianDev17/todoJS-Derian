...
const newTaskImput = document.querySelector('#new-task-input');
...
newTaskImput.addEventListener('keydown',(event)=>{
    if (event.key === "Enter") {
        addTask(app)
    }
})